...
- (void)viewDidLoad
{
    ...
    [self.deviceCtr initDevices:@"DEVICE_TYPE:电视"];
...
- (void)btnShortClk:(UIButton *)sender
{
    ...
    if (sender.tag == ADDNEW_LAMP_BUTTON_TAG) {
        AddDevViewController *tvadVc = [[AddDevViewController alloc] init];//TODO:1
        tvadVc.title = self.title;
    ...
    if (alertView.tag == ALERT_VIEW_UPDATE) {
        if (buttonIndex == 0) {         //取消
            ...
            if ([alertView textFieldAtIndex:0].text.length != 0) {
                ...
                if (isOK) {
                    ...
                    [self.deviceCtr initDevices:@"DEVICE_TYPE:电视"];//TODO:2
                    [self updateView:self.deviceCtr];
                }else {
        ...
        if (buttonIndex == 0) {         //取消
            ...
            if (isOK) {
                ...
                [self.deviceCtr initDevices:@"DEVICE_TYPE:电视"];//TODO:3
                [self updateView:self.deviceCtr];
